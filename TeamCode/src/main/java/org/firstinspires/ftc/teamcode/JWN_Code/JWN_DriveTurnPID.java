//JWN Code from https://stemrobotics.cs.pdx.edu/node/7268
//JWN PID Code from https://raw.githubusercontent.com/stemrobotics/Tetrix-Exercises/master/PIDController.java
...
package org.firstinspires.ftc.teamcode.JWN_Code;
...
@Autonomous(name="JWN_DriveTurnPID", group="Exercises")
//@Disabled
public class JWN_DriveTurnPID extends LinearOpMode
{
    DcMotor                 leftFront, leftBack, rightFront, rightBack;  //For use on Cataclysm
    //        TouchSensor             touch;
    BNO055IMU               imu;
...
//            rightMotor = hardwareMap.dcMotor.get("right_motor");
        ...
        rightFront = hardwareMap.get(DcMotor.class, "lf_drive");
        ...
        rightFront.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE); //JWN comment out for use on 2020-2021 robot
...
//                rightMotor.setPower(power + correction);
            holonomicDriveAuto(power,90 + correction,0);
